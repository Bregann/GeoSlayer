    ...
    IUserContextHelper userContextHelper) : ControllerBase
{
    ...
    [HttpPost("upgrades/{key}/purchase")]
    public async Task<ActionResult<PlayerUpgradesDto>> PurchaseUpgrade(string key, CancellationToken ct)
    {
